...
export const SEO_CONFIG = {
  title: 'CSW Ingeniería Civil - Herramientas de Cálculo',
  description: 'Herramientas profesionales de cálculo para ingeniería civil y estructural.',
  keywords: 'ingeniería civil, cálculo estructural, herramientas, CSW',
  canonical: 'https://www.cswingenieriacivil.com',
};
...
export const ROUTES = {
  ...
  armaduraFlexion: '/armadura-flexion',
};
